#>jinro_rpg:game/kills/bow2


##メイン
    execute at @s positioned as @p[tag=Perpetrator] run function km_distance:as_to_at
    function jinro_rpg:game/calc
    $tellraw @a[gamemode=spectator] [{"color":"red","text":"[人狼RPG] "},{"color":"white","player":"$(PerpetratorID)"}," ",{"color":"white","selector":"@e[scores={Znsi.ID=$(Perpetrator)},type=marker]"},{"color":"gray","text":"("},{"color":"white","text":"弓矢"},{"color":"gray","text":":"},{"color":"gray","score":{"name":"#Integer","objective":"Znsi.Distance"}},{"color":"gray","text":"."},{"color":"gray","score":{"name":"#Decimal","objective":"Znsi.Distance"}},{"color":"gray","text":"m"},{"color":"gray","text":") ➡ "},{"color":"white","player":"$(VictimID)"}," ",{"color":"white","selector":"@e[type=marker,scores={Znsi.ID=$(Victim)}]"},{"color":"white","text":" 死亡"}]
