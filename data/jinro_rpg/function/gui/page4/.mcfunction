...
##MAP名を決める
    ...
    execute if entity @s[nbt=!{Inventory:[{id:"minecraft:map",Slot:15b}]}] if data storage jinro_rpg: Setting.Map6.F_Pos.3 unless data storage jinro_rpg: Setting.Map6.Name run loot give @s loot {pools:[{rolls:1,entries:[{type:"minecraft:item",name:"minecraft:writable_book",functions:[{function:"minecraft:set_lore",entity:"this",lore:[{text:"署名し本のタイトルを入力することで",color:"gray",italic:false},{text:"MAP名を変更できます。",color:"gray",italic:false}],mode:"replace_all"},{function:"minecraft:set_custom_data",tag:{Maps:1b}},{function:"minecraft:set_custom_model_data",strings:{values:["Map6"],mode:"replace_all"}}]}]}],functions:[]}
...
##Forceload用の座標2
    ...
    execute if entity @s[nbt=!{Inventory:[{id:"minecraft:map",Slot:15b}]}] unless data storage jinro_rpg: Setting.Map6.F_Pos.3 if data storage jinro_rpg: Setting.Map6.F_Pos.1 run function jinro_rpg:gui/page4/f_pos2
...
##Forceload用の座標1
    ...
    execute if entity @s[nbt=!{Inventory:[{id:"minecraft:map",Slot:15b}]}] unless data storage jinro_rpg: Setting.Map6.F_Pos.1 if data storage jinro_rpg: Setting.Map6.Pos run function jinro_rpg:gui/page4/f_pos1
...
##座標をセット
    ...
    execute if entity @s[nbt=!{Inventory:[{id:"minecraft:map",Slot:15b}]}] unless data storage jinro_rpg: Setting.Map6.Pos run function jinro_rpg:gui/page4/set_start
...
##初期化
    ...
    execute if entity @s[nbt=!{Inventory:[{id:"minecraft:map",Slot:15b}]}] if data storage jinro_rpg: Setting.Map6.Pos if data storage jinro_rpg: Setting.Map6.Name run data remove storage jinro_rpg: Setting.Map6
