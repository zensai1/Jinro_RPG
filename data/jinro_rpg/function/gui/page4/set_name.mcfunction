...
#マップ名をストレージに入れる
    ...
    execute if items entity @s weapon.mainhand written_book[custom_model_data={strings:["Map5"]}] run data modify storage jinro_rpg: Setting.Map6.Name set from entity @s SelectedItem.components.minecraft:written_book_content.title.raw
    execute if items entity @s weapon.mainhand written_book[custom_model_data={strings:["Map6"]}] run data modify storage jinro_rpg: Setting.Map6.Name set from entity @s SelectedItem.components.minecraft:written_book_content.title.raw
