...
##SideA(ビーチ側)
    execute if entity @s[tag=SideA] run summon armor_stand ~ ~ ~ {Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["SideA","Gimmick"],equipment:{head:{id:"minecraft:white_harness",count:1}}}
...
##SideB(アクティビティエリア側)
    execute if entity @s[tag=SideB] run summon armor_stand ~ ~ ~ {Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["SideB","Gimmick"],equipment:{head:{id:"minecraft:white_harness",count:1}}}
